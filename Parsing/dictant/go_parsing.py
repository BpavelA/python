...
# with open("Python/Parsing/dictant/page.html", "w", encoding="utf8") as file:
#     file.write(site)

# Step 2

with open("Python/Parsing/dictant/page.html", "r", encoding="utf8") as file:
    src = file.read()
...
for name, link in result.items():
    ...
    with open(f'Python/Parsing/dictant/cert/{name}.jpg', "wb") as file:
